...
class testMaxFunctions(unittest.TestCase):
	def test_raunvx(self):
		self.assertEqual(sparnadur1b.raunvx(0, 12, 0.01), 0.036)
		self.assertEqual(sparnadur1b.raunvx(0, 18, 0.02), 0.028)
		self.assertEqual(sparnadur1b.raunvx(1, 36, 0.05), 0.0175)
		self.assertEqual(sparnadur1b.raunvx(1, 36, 0.09), 0.0175)
	...
	def test_hvad_er_best_ad_gera(self):
		self.assertEqual(sparnadur1b.hvad_er_best_ad_gera(12, 0.05), 'Ad borga inn a Overdtryggdur 12')
		self.assertEqual(sparnadur1b.hvad_er_best_ad_gera(36, 0.08), 'Ad borga inn a Verdtryggdur 36')	
