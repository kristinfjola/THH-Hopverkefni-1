...
class SvarGluggi(wx.Frame):
    ...
    def __init__(self,parent,id):
        ...
        #besti_kostur = hvad_er_best_ad_gera(self.innist_bundin);  -- �r hva�a file er �etta? lan_v e�a sparnadur1b?
        ...
        #besta_sparnadarleid = '<temp spar�anarlei�>'
        ...
        #fjarmagnstekjuskattur = '<temp fj�rmagnstekjuskattur>'
